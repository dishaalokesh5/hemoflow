export const BIOMARKER_ALIASES = {
  ...
  wbc: ["wbc count", "wbc", "white blood cell count", "total leucocyte count", "tlc"],
  platelets: ["platelet count", "platelets", "total platelet count", "plt"],
  hematocrit: ["packed cell volume", "pcv", "hematocrit"],
  ...
  vitamin_d: ["vitamin d", "25-hydroxy vitamin d", "25-oh vitamin d", "vit d", "vitamin d3", "25-hydroxy vit d"],
  ...
  alt: ["alt (sgpt)", "sgpt", "alanine transaminase", "alt"],
  ast: ["ast (sgot)", "sgot", "aspartate transaminase", "ast"],
  ...
  glucose_fasting: ["fasting glucose", "glucose fasting", "fasting blood sugar", "fbs", "glucose"],
  hba1c: ["hba1c", "glycated hemoglobin", "hb1c"],
