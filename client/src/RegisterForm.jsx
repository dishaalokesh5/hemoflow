  ...
  return (
    <div className="card-clean p-4 mx-auto" style={{ maxWidth: '440px' }}>
      <div className="mb-4 text-center">
        <h2 className="h5 fw-bold mb-1" style={{ color: '#1A1A1A' }}>Create Account</h2>
        <p className="text-muted-warm small mb-0">Sign up to save and track your blood reports</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label className="form-label text-muted-warm small fw-semibold">Confirm Password</label>
          <input
            type="password"
            className="form-control form-control-clean"
